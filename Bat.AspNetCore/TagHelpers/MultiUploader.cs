...
{
    public class MultiUploader : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            div.AddCssClass("dropzone multi-uploader");
            ...
            if (FileUrls != null && FileUrls.Count > 0)
                div.Attributes.Add("data-file-urls", JsonConvert.SerializeObject(FileUrls));
