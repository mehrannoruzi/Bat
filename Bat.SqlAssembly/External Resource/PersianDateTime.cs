...
namespace Bat.Sql
{
    ...
    public class PersianDateTime
    {
        ...
        private readonly static string[] _dayNames = new string[] { "‘‰»Â", "?ò‘‰»Â", "œÊ‘‰»Â", "”Â ‘‰»Â", "çÂ«—‘‰»Â", "Å‰Ã ‘‰»Â", "Ã„⁄Â" };
        private readonly static string[] _monthNames = new string[] { "›—Ê—œ?‰", "«—œ?»Â‘ ", "Œ—œ«œ", " ?—", "„—œ«œ", "‘Â—?Ê—", "„Â—", "¬»«‰", "¬–—", "œ?", "»Â„‰", "«”›‰œ" };

        private static string AM = "ﬁ.Ÿ";
        private static string PM = "».Ÿ";
        ...
        /// ò„ ò—œ‰ 2 ⁄œœ  «—?Œ ‘„”? «“ Â„œ?ê—
        /// </summary>
        /// <param name="d1"> «—?Œ ‘„”? «Ê·?</param>
        /// <param name="d2"> «—?Œ ‘„”? œÊ„?</param>
        /// <returns>„?“«‰ ›«’·Â ? »?‰ «?‰ 2  «—?Œ</returns>
        ...
        /// <param name="d1"> «—?Œ ‘„”? «Ê·?</param>
        /// <param name="d2"> «—?Œ ‘„”? œÊ„?</param>
        /// <returns>False ç‰«‰çÂ „ﬁœ«— «Ê·? »“—ê — »«‘œ œ— €?— «?‰ ’Ê—  True </returns>
        ...
        /// <summary>
        /// „ﬁ«?”Â 2  «  «—?Œ ‘„”? »« ?òœ?ê—   /// </summary>
        /// <param name="d1"> «—?Œ ‘„”? «Ê·?</param>
        /// <param name="d2"> «—?Œ ‘„”? œÊ„?</param>
        /// <returns>False ç‰«‰çÂ „ﬁœ«— «Ê·? »“—ê — Ê ?« „”«Ê? »«‘œ œ— €?— «?‰ ’Ê—  True </returns>
        public static bool operator >=(PersianDateTime d1, PersianDateTime d2)
        {
            return d1.ToDateTime() >= d2.ToDateTime();
        }
        ...
        /// <param name="d1"> «—?Œ ‘„”? «Ê·?</param>
        /// <param name="d2"> «—?Œ ‘„”? œÊ„?</param>
        /// <returns>False ç‰«‰çÂ „ﬁœ«— «Ê·? òÊçò — Ê ?« „”«Ê? »«‘œ œ— €?— «?‰ ’Ê—  True </returns>
        public static bool operator <=(PersianDateTime d1, PersianDateTime d2)
        {
            return d1.ToDateTime() <= d2.ToDateTime();
        }
        ...
        /// ò„ ò—œ‰ “„«‰? «“  «—?Œ ‘„”?
        /// </summary>
        /// <param name="d"> «—?Œ ‘„”?</param>
        /// <param name="t">“„«‰</param>
        /// <returns> «—?Œ ‘„”? ò”— ‘œÂ</returns>
        ...
        /// <param name="d1"> «—?Œ ‘„”? «Ê·?</param>
        /// <param name="d2"> «—?Œ ‘„”? œÊ„?</param>
        /// <returns>False ç‰«‰çÂ „ﬁœ«— «Ê·? òÊçò — »«‘œ œ— €?— «?‰ ’Ê—  True </returns>
        public static bool operator <(PersianDateTime d1, PersianDateTime d2)
        {
            return d1.ToDateTime() < d2.ToDateTime();
        }
        ...
        /// <param name="d1"> «—?Œ ‘„”? «Ê·?</param>
        /// <param name="d2"> «—?Œ ‘„”? œÊ„?</param>
        /// <returns>False ç‰«‰çÂ „ﬁœ«— «Ê·? œﬁ?ﬁ«»« „ﬁœ«— œÊ„? ?ò”«‰ »«‘œ(Â„ œ—  «—?Œ Ê Â„ œ— “„«‰ ) œ— €?— «?‰ ’Ê—  True </returns>
        public static bool operator ==(PersianDateTime d1, PersianDateTime d2)
        {
        ...
        /// <param name="d1"> «—?Œ ‘„”? «Ê·?</param>
        /// <param name="d2"> «—?Œ ‘„”? œÊ„?</param>
        /// <returns>False ç‰«‰çÂ „ﬁœ«— «Ê·? „Œ«·› „ﬁœ«— œÊ„ »«‘œ œ— €?— «?‰ ’Ê—  True </returns>
        public static bool operator !=(PersianDateTime d1, PersianDateTime d2)
        {
            return !(d1 == d2);
        }
        ...
        /// œ—?«›  ‰«„ „«Â œ—ŒÊ«” ?
        /// </summary>
        /// <param name="month">⁄œœ „«Â »?‰ 1  « 12</param>
        /// <returns>‰«„ „«Â œ—ŒÊ«” ?</returns>
        ...
        /// œ—?«›  ‰«„ —Ê“ œ—ŒÊ«” ?
        /// </summary>
        /// <param name="day">⁄œœ —Ê“ »?‰ 0  « 6</param>
        /// <returns>‰«„ —Ê“ œ—ŒÊ«” ?</returns>
        ...
        ///  ‘Œ?’ «?‰òÂ ¬?« ”«· Ã«—? ”«· ò»?”Â Â”  ?« Œ??—
        /// </summary>
        /// <param name="year">⁄œœ ”«· Ê—Êœ? »?‰ 1  « 9378</param>
        /// <returns>»·? ° œ— ’Ê— ? òÂ ”«· œ—ŒÊ«” ? ”«· ò»?”Â »«‘œ</returns>
        ...
        /// </summary>
        /// <param name="year">⁄œœ ”«· Ê—Êœ? »?‰ 1  « 9378</param>
        /// <returns>ç‰«‰çÂ ”«· „⁄„Ê·? »«‘œ ⁄œœ 365 »«“ê—œ«‰œÂ „? ‘Êœ œ— €?— «?‰ ’Ê—  366</returns>
        ...
        /// »œ?·  «—?Œ „?·«œ? »Â ‘„”?
        /// </summary>
        /// <param name="miladiDate"> «—?Œ „?·«œ?</param>
        ...
        /// »«“ê—œ«‰œ‰ „?“«‰ “„«‰ ê–‘ Â «“  «—?Œ «—”«·? »Â ›«—”?
        /// </summary>
        /// <param name="dateTime"> «—?Œ Ê—Êœ? »Â „?·«œ?</param>
        /// <returns>»«“ê—œ«‰œ‰ „?“«‰ “„«‰ ê–‘ Â «“  «—?Œ «—”«·? »Â ›«—”? „«‰‰œ ?ò œﬁ?ﬁÂ ﬁ»·</returns>
        public static string GetRelativeTime(DateTime dateTime)
        {
            ...
            if (delta < 1 * MINUTE)
            {
                return ts.Seconds == 1 ? "·ÕŸÂ «? ﬁ»·" : ts.Seconds + " À«‰?Â ﬁ»·";
            }
            if (delta < 2 * MINUTE)
            {
                return "?ò œﬁ?ﬁÂ ﬁ»·";
            ...
            if (delta < 12 * MONTH)
            {
                ...
                return months <= 1 ? "?ò „«Â ﬁ»·" : months + " „«Â ﬁ»·";
            }
            int years = Convert.ToInt32(Math.Floor((double)ts.Days / 365));
            return years <= 1 ? "?ò ”«· ﬁ»·" : years + " ”«· ﬁ»·";
        }
    }
