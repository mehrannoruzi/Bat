...
namespace Bat.EntityFrameworkCore.Tools
{
    ...
    public static class GroupingExtension
    {
        ...
        public static IEnumerable<Grouping<TKey1, TElement>> GroupByMany<TElement, TKey1, TKey2>(this IEnumerable<TElement> orderedElements,
            Func<TElement, TKey1> groupByKey1Expression, Func<TElement, TKey2> groupByKey2Expression,
        ...
        public static List<TElement> GroupByWithRollup<TElement, TKey1, TKey2>(this IEnumerable<TElement> orderedElements,
            Func<TElement, TKey1> groupByKey1Expression, Func<TElement, TKey2> groupByKey2Expression,
            Func<IGrouping<TKey1, TElement>, IGrouping<TKey2, TElement>, TElement> newElementExpression,
        ...
        public static int SubTotal<TKey, TElement>(this IGrouping<TKey, TElement> query, Func<TElement, int> sumExpression)
            => query.Sum(group => sumExpression(group));
        ...
        public static int GrandTotal<TKey, TElement>(this IEnumerable<Grouping<TKey, TElement>> query, Func<TElement, int> sumExpression)
            => query.Sum(group => group.Sum(innerGroup => sumExpression(innerGroup)));
